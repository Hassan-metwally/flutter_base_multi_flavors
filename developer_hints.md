...
## App Bundles :
                        ## IOS ##                 |          ## Android ##
                ------------------------------------------------------------------
    [Client]    com.moltaqa.azhimny.client        |     com.moltaqa.azhimny.client
    [Provider]  com.moltaqa.azhimny.provider      |     com.moltaqa.azhimny.provider


## BUILD APK && IPA: 
 - For IOS :
    flutter build ipa --flavor client -t lib/_main_client.dart
    flutter build ipa --flavor provider -t lib/_main_provider.dart

 - For Android :
    flutter build apk --release --flavor client -t lib/_main_client.dart
    flutter build apk --release --flavor provider -t lib/_main_provider.dart

 - For Android [Build App Bundle] :
    flutter build appbundle --flavor client -t lib/_main_client.dart
    flutter build appbundle --flavor provider -t lib/_main_provider.dart
