...
abstract class AppLocalizations {
  ...
  /// No description provided for @pleaseSelectRepresentativeType.
  ///
  /// In en, this message translates to:
  /// **'Please select representative type'**
  String get pleaseSelectRepresentativeType;
  ...
  ///
  /// In en, this message translates to:
  /// **'Select your account type as a provider or a representative.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Display your services and products and let delivery representatives deliver them to those who need them!'**
  String get providerOnBoardingTitle2;

  /// No description provided for @providerOnBoardingSubTitle2.
  ///
  /// In en, this message translates to:
  /// **'Easier management, clearer orders, and delivery representatives ready for delivery.'**
  ...
  /// No description provided for @totalNumberOfRepresentatives.
  ///
  /// In en, this message translates to:
  /// **'Representatives'**
  String get totalNumberOfRepresentatives;
