...
import '../../../../src/_client_app/client_firebase_options.dart';
import '../../../../src/_provider_app/provider_firebase_options.dart';
...
class FirebaseHelper {
  ...
  static Future<void> init(AppEnvironmentEnum env) async {
    await _initializeFirebaseApp(env);
  ...
  static Future<void> _initializeFirebaseApp(AppEnvironmentEnum env) async {
    switch (env) {
      ...
      case AppEnvironmentEnum.provider:
        await Firebase.initializeApp(options: ProviderFirebaseOptions.currentPlatform);
    }
  }
...
Future<void> userFirebaseOnMessagingBackground(RemoteMessage message) async {
  ...
  await FirebaseHelper._initializeFirebaseApp(AppEnvironmentEnum.client);
}

@pragma('vm:entry-point')
Future<void> providerFirebaseOnMessagingBackground(RemoteMessage message) async {
  log("Get Provider Notification On Background [Data] ::: ${message.data}", name: "Get FCM Notification In Background");
  await FirebaseHelper._initializeFirebaseApp(AppEnvironmentEnum.provider);
}
