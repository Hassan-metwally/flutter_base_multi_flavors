...
import '../authentication/presentation/login/login_cubit.dart';
import '../authentication/presentation/login/provider_login_page.dart';
import '../common/presentation/splash/splash_page.dart';
import 'main_page/provider_main_page.dart';
import 'onboarding/provider_onboarding_page.dart';
              ...
              child: ValueListenableBuilder(
                ...
                builder: (context, themeValue, child) {
                  return MaterialApp(
                    ...
                    title: EnvironmentsConfig.of(context).appTitle,
                    ...
                    onGenerateInitialRoutes: (String initialRoute) {
                      return [AppRoutesGenerator.generateRoute(const RouteSettings(name: AppRoutes.providerHome))];
                    },
                  );
                },
              ),
...
class ProviderBuilderScreen extends StatelessWidget {
  const ProviderBuilderScreen({super.key});
    ...
    return BlocBuilder<AppAuthenticationBloc, AppAuthenticationState>(
      builder: (context, state) {
        ...
        if (state is AuthUninitialized) {
          ...
          root = const ProviderOnboardingPage();
        } else if (state is AuthUnauthenticated || state is AuthLogInPageState || state is AuthLogOutState) {
          root = BlocProvider(create: (context) => LoginCubit(), child: const ProviderLoginPage());
        } else {
